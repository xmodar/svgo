...
def build_metadata_files() -> dict[str, bytes]:
    ...
    metadata = "\n".join(
        [
            ...
            f"Name: {NAME}",
            f"Version: {VERSION}",
            "Summary: Pure-Python SVG path editing, optimization, matrix geometry, validation, tracing, and centerline reconstruction.",
            "Author: xmodar",
            "License: MIT",
            ...
            "Keywords: svg,path,optimizer,matrix,validation,trace,centerline,cli",
